...
public class Color {
    public static AnsiColors bg = new AnsiColors(40);
    public static AnsiColors fg = new Color.AnsiColors(30);

    protected static class AnsiColors {
